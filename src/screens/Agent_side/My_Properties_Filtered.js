...
const My_Properties_Filtered = () => {
  ...
  const filterData = () => {
    ...
    return Alldata.filter(item => item.salestaues === category);
  };
    ...
    <View style={[styles.allflatbox]}>
      ...
      <View style={{paddingHorizontal: wp(3)}}>
        <View
          ...
          <TouchableOpacity>
            <AntDesign name="hearto" color={Colors.main} size={22} />
          </TouchableOpacity>
        </View>
  ...
  return (
    <View style={styles.container}>
      <View style={[authstyles.header, {marginBottom: wp(4)}]}>
        ...
        <Text style={authstyles.headertext}>{category}</Text>
        <View></View>
      </View>
      <FlatList
        data={filterData()}
...
export default My_Properties_Filtered;
