  ...
  return (
    <View style={styles.container}>
      <View style={authstyles.header}>
        ...
        <Text style={authstyles.headertext}>Add New Property</Text>
        <View></View>
      </View>
      <ScrollView>
        <View>
          ...
          <View style={{marginTop: wp(2)}}>
            <Text style={authstyles.heading}>Country</Text>
          ...
          <View style={{marginTop: wp(2)}}>
            <Text style={authstyles.heading}>Country / State</Text>
            <View style={authstyles.inputview}>
              <TextInput
          ...
          <View style={{marginTop: wp(2)}}>
            <Text style={authstyles.heading}>Postal Code / Zip*</Text>
            <View style={authstyles.inputview}>
              <TextInput
                placeholder="Enter your prop zip code"
                placeholderTextColor={Colors.gray}
                style={authstyles.inputtext}
              />
            </View>
          ...
          <Text style={authstyles.heading}>
            Drag and drop the pin on map to find exect location
          </Text>
          ...
          <View style={{marginTop: wp(2)}}>
            <Text style={authstyles.heading}>Private Note</Text>
            <View
              style={[
                authstyles.inputview,
                {height: wp(30), alignItems: 'flex-start'},
              ...
              <TextInput
                placeholder="Enter Note,it well be not visible to public"
                placeholderTextColor={Colors.gray}
                style={authstyles.inputtext}
                multiline
                textAlignVertical="top"
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <AntDesign
                name={agree ? 'checksquare' : 'checksquareo'}
                size={22}
                color={agree ? Colors.main : Colors.gray}
              />
            </TouchableOpacity>
            <Text style={styles.agretext}>
              Agree & Comply with Terms and Condition
            </Text>
          </View>
        </View>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('Add_New_Property2');
            }}
            style={{
              width: wp(25),
              height: wp(12),
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('Add_New_Property_Payment');
            }}
            style={{
              width: wp(25),
              height: wp(12),
...
export default Add_New_Property3;
