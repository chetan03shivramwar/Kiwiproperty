...
const AgentBungalow = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
            <View style={authstyles.header}>
                ...
                <Text style={authstyles.headertext}>Bungalow/Detached House</Text>
                <View></View>
            </View>
            <ScrollView>
              ...
              View All
                ...
                <View style={{ marginBottom: wp(2), borderBottomWidth: 1, borderBottomColor: 'lightgrey', paddingBottom: wp(5) }}>
                    <FlatList
                        data={filteredData}
                                    ...
                                    >
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: wp(2), marginBottom: wp(2) }}>
                                            <View style={{ paddingHorizontal: wp(2), paddingVertical: wp(1), borderRadius: wp(1), }}>
                                                <Text style={{ fontSize: 14, fontFamily: fonts.Medium, color: Colors.white }}>{item.price}</Text>
                                            </View>
                                            <TouchableOpacity
