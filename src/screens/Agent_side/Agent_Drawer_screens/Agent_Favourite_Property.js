...
const Agent_Favourite_Property = () => {
    ...
    <View style={[styles.allflatbox]}>
      ...
      <View style={{paddingHorizontal: wp(3)}}>
        <View
          ...
          <TouchableOpacity>
            <AntDesign name="heart" color={Colors.main} size={22} />
          </TouchableOpacity>
        </View>
  ...
  return (
    <View style={styles.container}>
      <View style={[authstyles.header, {marginBottom: wp(4)}]}>
        ...
        <Text style={authstyles.headertext}>My Favourite Property</Text>
        <View></View>
      </View>
      <FlatList
        data={Alldata}
...
export default Agent_Favourite_Property;
