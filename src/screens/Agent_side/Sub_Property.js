  ...
  return (
    <View style={styles.container}>
      <View style={authstyles.header}>
        ...
        <Text style={authstyles.headertext}>Sub Property</Text>
        <View></View>
      </View>
      <ScrollView>
        <View>
          <View>
            <View style={[styles.desbox, {width: wp(90)}]}>
              <Text style={[[authstyles.heading, {marginLeft: wp(2)}]]}>
                Multi Units / Sub Properties for Luxury villa with oceanview
              </Text>
            </View>

            <Text
              style={[
                [authstyles.heading, {marginRight: wp(5), marginTop: wp(6)}],
              ]}>
            ...
            <TouchableOpacity
              ...
              <AntDesign
                name={floorplan ? 'downcircleo' : 'upcircleo'}
                size={22}
                color={Colors.black}
              />
            </TouchableOpacity>
