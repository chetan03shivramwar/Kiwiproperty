...
const UserPenthHouse = ({navigation}) => {
    ...
    const Alldata = [
        {
            ...
            sqft: '4500',
            type: 'Codominium',
            name: 'Always Windy During the Night',
            location: 'New York',
            date: '6 months ago',
            image: images.prop1,
            salestaues: 'FOR RENT',
  ...
  return (
    ...
    <View style={authstyles.header}>
        ...
        <Text style={authstyles.headertext}>Penthhouse</Text>
        <View></View>
    </View>
    <ScrollView>
