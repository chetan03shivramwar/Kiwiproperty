...
const Home = () => {
  ...
  // console.log('my dataaaa',JSON.stringify(posts))
  ...
  useEffect(() => {
    axios.get('https://kiwi.sg/wp-json/wp/v2/properties')
      .then(response => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
              ...
              renderItem={({ item, index }) => {
                return (
                  <TouchableOpacity
                    ...
                    <ImageBackground source={item.image} style={[styles.image, { justifyContent: 'space-between', width: wp(70) }]} borderTopLeftRadius={wp(3)} borderTopRightRadius={wp(3)} >
                      ...
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: wp(2), marginBottom: wp(2) }}>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                          <TouchableOpacity
                            // Handle press event
                            style={{ paddingHorizontal: wp(1), marginRight: wp(2), paddingVertical: wp(1), borderRadius: wp(1), justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,.7)', }}
                          >
                            <AntDesign
                              name='hearto'
                              size={18}
                          ...
                          <TouchableOpacity
                            // Handle press event
                            style={{ paddingHorizontal: wp(1), paddingVertical: wp(1), borderRadius: wp(1), justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,.7)', }}
                          >
                            <FontAwesome5
                              name='plus'
                              size={16}
        ...
        <View style={[styles.row, { marginTop: wp(3), marginBottom: wp(2) }]}>
          <Text style={styles.heading}>Featured Properties</Text>
          {/* <TouchableOpacity
              onPress={() => {
                navigation.navigate('All_Propperties');
          ...
          <View style={styles.selectmodal}>
            ...
            <View>
              ...
              <TouchableOpacity
                activeOpacity={0.8}
                style={styles.selectbox}
                onPress={() => setPreferredCurrency(!preferredCurrency)}
              >
                <Text style={styles.selecttext}>
                  {selectedCurrency ? selectedCurrency : 'USD'}
                </Text>
