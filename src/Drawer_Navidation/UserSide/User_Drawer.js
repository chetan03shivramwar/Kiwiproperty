...
import User_Custom_Drawer from './User_Custom_Drawer';
...
import AffiliateMemberWrapper from '../../components/AffiliateMemberWrapper';

const Tab = createDrawerNavigator();

const User_Drawer = React.forwardRef(ref => {
  return (
    <Tab.Navigator
      ref={ref}
      drawerContent={props => <User_Custom_Drawer {...props} />}
      ...
      /> */}
       <Tab.Screen
        name="Affiliate_Member"
        component={Affiliate_Member} // Use the wrapper component
        options={{
          drawerLabel: ({focused}) => (
            <Text
              style={[
